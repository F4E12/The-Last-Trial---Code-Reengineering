...
public class PlayerAnimationManager {
    ...
    public PlayerAnimationManager() {
        animationController.addAnimation(PlayerStateEnum.IDLE,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_idleedited.png", 4, 150)));
        animationController.addAnimation(PlayerStateEnum.WALKING,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_walk.png", 8, 40)));
        animationController.addAnimation(PlayerStateEnum.JUMPING,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_jump.png", 4, 200)));
        ...
        animationController.addAnimation(PlayerStateEnum.FALLING,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_fall.png", 2, 150)));
        animationController.addAnimation(PlayerStateEnum.ATTACKING,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_attack_2.png", 8, 23), 80, 60));
        animationController.addAnimation(PlayerStateEnum.ATTACKING | PlayerStateEnum.JUMPING,
            new CharacterAnimation(new AnimationConfig("/assets/sprite/player/player_attack_airborne.png", 8, 23), 80, 60));
